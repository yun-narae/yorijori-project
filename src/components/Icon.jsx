...
export const Icon = ({
    ...
    return (
        <div className={`relative flex items-center justify-center ${className} ${frameClass} ${hoverfillClass}`}>
            <svg
                className={`${className} ${iconClass} ${stateClass} ${svgHoverClass}`} aria-hidden="true"
            >
