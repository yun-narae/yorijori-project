...
export default function PostDetail() {
    ...
    // Derived
    const isOwner = React.useMemo(() => isOwnerOf(post, user?.id), [post, user?.id]);
    ...
    // Bind/refresh swiper navigation on resize or instance ready
    useEffect(() => {
        ...
        const rebindNav = () => {
            ...
            // 780px 이상에서만 화살표 활성화
            const enable = window.matchMedia("(min-width: 780px)").matches;
            swiperInst.params.navigation.enabled = enable;
